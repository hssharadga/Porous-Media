...
#If the selected sphere is near the walls the find a new sphere  
        if main_sphere_center[0]>xlow or main_sphere_center[0]<xhigh or main_sphere_center[1]>ylow or main_sphere_center[1]<yhigh :
            break
...
#calculation of the distance of all the spheres in the list to the emitted ray and checking the spheres that are being hit by the ray
    ...
    p2= np.array([emission_point[0]+dir_cos_line_grdframe[0]*l,emission_point[1]+dir_cos_line_grdframe[1]*l])
