# -*- coding: utf-8 -*-
"""
Created on Wed Jan 22 17:39:13 2020
...
#If any of the above conditions is true then do the tracing again and so deleting the previous step      
            if overlap==True:
                ...
                if iii > 100:
                    ...
                    iii = 0
                    continue
                continue# if tje overlap go back to while loop and generate another cirlce being hit by the ray
            # if the spheres continue to overlap more than 100 tiems then delete the last point (last sphere) and chenge the place of that sphere, thus two spheres are deleted
...
#code for checking whether to do reflection or refraction
            ...
            if rand1< rho_avg: # spectral reflection
                ...
                reflected_dir_cos1 = np.array([(Dir_cosines[ii][0] - 2*normal_dir_cos[0]*dot_prod), (Dir_cosines[ii][1] - 2*normal_dir_cos[1]*dot_prod)])
